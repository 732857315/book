    ...
    <div className={index.box}>
      ...
      <div className={index.menu}>
        ...
        <div className={index.menuitem + ' ' + index.menuactive}>
          <a target='_blank' href='https://732857315.github.io/book' >主页</a>
          </div>
        <div className={index.menuitem}>
          <a target='_blank' href='https://732857315.github.io/book' >Gitee</a>
        </div>
        <div className={index.menuitem}>
          <a target='_blank' href='https://732857315.github.io/book' >博客</a>
        </div>
      </div>
      <div className={index.menuinfo}>
        ...
        吴  修改于2021年1月1日
        <br />
        <e className={index.email}>732857315@qq.com</e>
        <br />
